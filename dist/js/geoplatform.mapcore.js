...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('leaflet'), require('q'), require('geoplatform.client'), require('jquery'), require('esri-leaflet'), require('leaflet-timedimension')) :
    typeof define === 'function' && define.amd ? define(['leaflet', 'q', 'geoplatform.client', 'jquery', 'esri-leaflet', 'leaflet-timedimension'], factory) :
    (global.GeoPlatformMapCore = factory(global.L,global.Q,global.GeoPlatformClient,global.jQuery,global.L.esri,global.L.TimeDimension));
}(this, (function (L$1,Q,GeoPlatformClient,jQuery,esri,leafletTimedimension) { 'use strict';
