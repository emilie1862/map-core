...
(function (global, factory) {
...
}(this, (function (L$1,Q,GeoPlatformClient,jQuery,esri) { 'use strict';
    ...
    */
    ...
    var FeatureLayer$1 = L$2.esri.FeatureManager.extend({
      ...
      initialize: function initialize(options) {
        ...
        options = L$2.setOptions(this, options);

        this._layers = {};
        this._leafletIds = {};

        this.cluster = L$2.markerClusterGroup(options);
      ...
      createLayers: function createLayers(features) {
        ...
        for (var i = features.length - 1; i >= 0; i--) {
          ...
          if (!layer) {
            var newLayer = L$2.GeoJSON.geometryToLayer(geojson, this.options);
            newLayer.feature = L$2.GeoJSON.asFeature(geojson);
        ...
        function MapInstance(key) {
            ...
            _this._geoJsonLayerOpts = {
                ...
                onEachFeature: function onEachFeature(feature, layer) {
                    ...
                    feature.properties.id = props.id || Math.floor(Math.random() * 999999);
